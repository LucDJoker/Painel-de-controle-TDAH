...
export default function MainApp() {
  ...
  // Marca a versão sem apagar dados do usuário.
  // Antes o app limpava todo o localStorage ao mudar a versão, o que podia apagar tarefas, finanças e login.
  useEffect(() => {
    const versaoApp = '2.0-organizamente';
        ...
        <Card className="mb-6 shadow-lg bg-card text-card-foreground border-border">
          <CardHeader className="pb-3">
            <div className="flex justify-between items-center">
              <CardTitle className="text-xl font-semibold">Central de Foco</CardTitle>
            </div>
          </CardHeader>
          <CardContent>
